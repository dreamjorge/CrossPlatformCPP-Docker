...
echo DEBUG: VS_YEAR=%VS_YEAR%
echo DEBUG: VS_VERSION=%VS_VERSION%
echo DEBUG: CONFIG=%CONFIG%
echo DEBUG: Current directory:
cd
echo DEBUG: Listing C:\app\scripts\windows:
...
echo INFO: Starting build process for Visual Studio %VS_YEAR%...
CALL "%VS_DEV_CMD%" ^
