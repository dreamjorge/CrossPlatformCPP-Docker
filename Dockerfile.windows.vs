...
# Debugging environment variables using PowerShell
RUN powershell -Command \
    Write-Output "VS_VERSION is $env:VS_VERSION; VS_YEAR is $env:VS_YEAR; CMAKE_VERSION is $env:CMAKE_VERSION"
...
# Detect MSVC version and set it as an environment variable
RUN powershell -Command \
    try { \
